...
FIX: Accepts demo=True/False to switch between practice and live URLs.
     Logs clearly which endpoint is being used to help debug auth issues.
"""
    ...
    def login(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                log.error("Login failed: 401 Unauthorized — API key is wrong or expired")
                log.error("Check: Is this a PRACTICE key? (demo_mode=true uses api-fxpractice.oanda.com)")
                log.error("Check: Is this a LIVE key?     (demo_mode=false uses api-trade.oanda.com)")
